...
# DVE full session
# Saved on Wed May 8 15:36:16 2019
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 405} {height 905} {dock_state left} {dock_on_new_line true} {child_hier_colhier 271} {child_hier_coltype 128} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 904
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 272} {height 905} {dock_state left} {dock_on_new_line true} {child_data_colvariable 271} {child_data_colvalue 100} {child_data_coltype 45} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2559} {height 360} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_1" { layer_tb.time_val layer_tb.output_spike_times layer_tb.L0.li_winning_neuron layer_tb.L0.winning_neuron }

set _session_group_2 Group2
gui_sg_create "$_session_group_2"
set Group2 "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { layer_tb.output_spike_times }
...
catch { gui_list_select -id ${Data.1} {layer_tb.L0.winning_neuron }}
